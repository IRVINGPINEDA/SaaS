...
MINIO_BUCKET = os.getenv("MINIO_BUCKET", "tesis-docs")
...
def get_minio_public() -> Minio:
    # Solo para generar URLs presignadas accesibles desde el navegador (no necesariamente resoluble desde el contenedor).
    return Minio(
